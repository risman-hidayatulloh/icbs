    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <table id="mytable" class="table table-striped table-bordered table-hover table-full-width dataTable" cellspacing="0" width="100%">
                ...
                <tr><td>NAMA</td><td><input type="text" id="nama" placeholder="NAMA SISWA" class="form-control" readonly></td></tr>
                <tr><td>JURUSAN</td><td><input type="text" id="jurusan" placeholder="JURUSAN" class="form-control" readonly></td></tr>
