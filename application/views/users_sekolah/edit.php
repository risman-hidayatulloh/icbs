<div class="col-sm-12">
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <?php
            echo form_open_multipart('users_sekolah/edit', 'role="form" class="form-horizontal"');
            echo form_hidden('id_user_sekolah',$user['id_user_sekolah']);
            ?>
            ...
            <div class="form-group">
                ...
                <div class="col-sm-2">
                    ...
                    <img src="<?php echo base_url().'uploads/foto_user_sekolah/'.$user['foto']?>" width="200">
                </div>
            </div>
            <div class="form-group">
                <label class="col-sm-2 control-label" for="form-field-1">
                ...
                <div class="col-sm-1">
                    <?php echo anchor('users_sekolah', 'Kembali', array('class' => 'btn btn-info btn-sm')); ?>
                </div>
            </div>
            </form>
        </div>
