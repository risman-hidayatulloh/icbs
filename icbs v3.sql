...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2018 at 12:21 PM
...
(23, 'Pengeluaran', 'jenis_pembayaran', 'fa fa-credit-card', 0),
...
(31, 'Penerimaan', 'jenis_penerimaan', 'fa fa-credit-card', 0);
...
CREATE TABLE IF NOT EXISTS `tbl_jenis_penerimaan` (
`id_jenis_penerimaan` int(11) NOT NULL,
  `nama_jenis_penerimaan` varchar(50) NOT NULL
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=9 ;
...
INSERT INTO `tbl_jenis_penerimaan` (`id_jenis_penerimaan`, `nama_jenis_penerimaan`) VALUES
(3, 'SPP'),
(4, 'Buku'),
(5, 'Daftar Ulang'),
(7, 'Wisuda'),
...
CREATE TABLE IF NOT EXISTS `tbl_kelompok_mapel` (
...
(7, '0000-00-00', '1602474', 1, 0, ''),
(8, '0000-00-00', '1602474', 1, 0, ''),
(9, '0000-00-00', '1602474', 1, 0, ''),
(10, '0000-00-00', '1602474', 1, 0, ''),
(11, '0000-00-00', '1602474', 1, 0, ''),
(12, '0000-00-00', '1602474', 1, 0, ''),
(13, '0000-00-00', '1602474', 1, 0, ''),
(14, '0000-00-00', '1602474', 1, 0, ''),
(15, '0000-00-00', '1602474', 1, 0, ''),
(16, '2018-08-08', '1602474', 3, 500, ''),
(17, '2018-08-09', '1602474', 8, 900000, 'Cicilan');
...
CREATE TABLE IF NOT EXISTS `tbl_sekolah_info` (
...
CREATE TABLE IF NOT EXISTS `tbl_sms_group` (
`id` int(11) NOT NULL,
...
--
ALTER TABLE `tbl_jenis_penerimaan`
MODIFY `id_jenis_penerimaan` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=9;
--
