...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 19, 2018 at 03:42 PM
...
(8, 'Data Presensi', 'santri_kehadiran', 'clip-book', 6),
(9, 'Karyawan', '#', 'clip-user-5', 0),
(10, 'Data Pribadi', 'users_sekolah', 'clip-pencil-3', 9),
(11, 'Rekap Kehadiran', 'karyawan_kehadiran', 'clip-book', 9),
(12, 'Data Pemasukan', '#', 'fa fa-money', 0),
(13, 'Dari Santri', 'pemasukan_santri', 'fa fa-plus', 12),
(14, 'Sumber Lain', 'pemasukan_sumber_lain', 'fa fa-plus', 12),
(15, 'Data Pengeluaran', '#', 'fa fa-money', 0),
(16, 'Laporan Keuangan', '#', 'clip-note', 0),
(17, 'Pemasukan', 'laporan_pemasukan_keuangan', 'clip-file-plus', 16),
(18, 'Pengeluaran', 'laporan_pengeluaran_keuangan', 'clip-file-minus', 16),
(19, 'Laporan Pesan', '', 'fa fa-comments-o', 0),
(20, 'Dari Santri', 'pesan_santri', 'fa fa-paper-plane-o', 19),
(21, 'Dashboard', 'home', 'clip-home-2', 0),
(22, 'Data Pribadi', 'data_pribadi', 'clip-user-5', 0),
(23, 'Rekap Kehadiran', 'rekap_kehadiran', 'clip-note', 0),
(24, 'Catatan Belanja', 'catatan_belanja', 'clip-cart', 0),
(25, 'Data Pembayaran', '#', 'fa fa-money', 0),
(26, 'Daftar Ulang', 'daftar_ulang', 'clip-checkmark-circle', 25),
(27, 'SPP', 'spp', 'clip-checkmark-circle', 25),
(28, 'Buku', 'buku', 'clip-checkmark-circle', 25),
(29, 'Infaq', 'infaq', 'clip-checkmark-circle', 25),
(30, 'Pesan', '#', 'fa fa-comments-o', 0),
(31, 'Tulis Pesan', 'tulis_pesan', 'fa fa-paper-plane-o', 30),
(32, 'Pesan Masuk', 'pesan_masuk', 'clip-paperclip', 30),
...
INSERT INTO `tabel_rombel` (`id_rombel`, `nama_rombel`, `kelas`) VALUES
(1, '1 A', 1),
(2, '1 B', 1),
(3, '2 A', 2),
(4, '2 B', 2),
...
--
-- Dumping data for table `tbl_user_santri`
--

INSERT INTO `tbl_user_santri` (`username`, `password`, `nama`, `gender`, `tempat_lahir`, `tanggal_lahir`, `kd_agama`, `foto`, `id_rombel`, `tahun_masuk`, `id_level_user`) VALUES
('1602474', '2baaf365922ec505a0ff39ccf34a77f1', 'risman', 'L', 'Garut', '2018-08-19', '01', '', 1, '2018', 0),
('1602475', 'a7934c54c06a0c23329e8cb0d5f65f5f', 'hidayatulloh', 'L', 'Garut', '2018-08-19', '01', '', 2, '2018', 0),
('1602490', '25d55ad283aa400af464c76d713c07ad', 'RW', 'L', 'Garut', '2018-08-23', '01', '', 0, '2018', 3),
('santri', '7d1959dcd37659e4cfdc794945cea9a8', 'Risman H', 'L', 'Garut', '2018-08-19', '01', 'user-siluet.jpg', 0, '2020', 3);
...
(2, 'ICBS Ponpes', 'ponpes', '44115cdffaa851462e627d408018696f', 2, 'logo1.png');
...
--
ALTER TABLE `tbl_user_sekolah`
  MODIFY `id_user_sekolah` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
COMMIT;
