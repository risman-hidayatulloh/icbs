...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 09, 2018 at 05:24 PM
...
(38, 'Pembayaran', '#', 'fa fa-database', 0),
(39, 'SPP', 'laporan_pembayaran/spp', 'fa fa-dollar', 38),
(40, 'Kehadiran', '#', 'fa fa-calendar', 0),
(41, 'Daftar Ulang', 'laporan_pembayaran/daftar_ulang', 'fa fa-calendar', 38),
(42, 'Pembelian Buku', 'laporan_pembayaran/buku', 'fa fa-book', 38);
...
CREATE TABLE IF NOT EXISTS `tbl_biaya_pemasukan` (
...
CREATE TABLE IF NOT EXISTS `tbl_jenis_pemasukan` (
`id_jenis_pemasukan` int(11) NOT NULL,
...
(16, '2018-08-08', '1602474', 3, 200000, 'LUNAS'),
(17, '2018-08-08', '1602474', 3, 200000, 'LUNAS');
...
--
ALTER TABLE `tbl_jenis_pemasukan`
MODIFY `id_jenis_pemasukan` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=7;
--
...
--
ALTER TABLE `tbl_user_rule`
MODIFY `id_rule` int(11) NOT NULL AUTO_INCREMENT,AUTO_INCREMENT=95;
--
